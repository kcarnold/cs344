...
- Reminder: exam questions
- Pulse check: Are expectations and workload clear? reasonable?
...
- Reminder: exam questions
  - Friday: second question and first *review*
- Project ideas: see Moodle forum

---

## Recap

Which data do you absolutely need in your database for training a movie recommender system based on collaborative filtering? Choose all that apply:

1. Title
2. Genre
3. User
4. User's Stated Genre Preferences
5. User's Reaction
6. User's Watch Timestamp
